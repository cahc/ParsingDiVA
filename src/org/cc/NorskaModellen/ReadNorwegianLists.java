    ...
    public static List<NorskSerie> parseSeries(File file) throws IOException {
       ...
       // System.out.println("# tidskrifter/serier: " + tidskrifter.getLastRowNum()); // zero indexed
        ...
        while (rowIterator.hasNext()) {
            ...
            cell = row.getCell(NorskSerieIndex.Nivå_2027.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskSerie.setNivå2027(Integer.valueOf(formatter.formatCellValue(cell)));

            //nivå 2026

            cell = row.getCell(NorskSerieIndex.Nivå_2026.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskSerie.setNivå2026(Integer.valueOf(formatter.formatCellValue(cell)));
            ...
            cell = row.getCell(NorskSerieIndex.Nivå_2024.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskSerie.setNivå2024(Integer.valueOf(formatter.formatCellValue(cell)));
    ...
    public static List<NorskFörlag> parseFörlag(File file) throws IOException {
       ...
       // System.out.println("# förlag: " + förlag.getLastRowNum()); // zero indexed
        ...
        while (rowIterator.hasNext()) {
            ...
            cell = row.getCell(NorskFörlagIndex.Nivå2027.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskFörlag.setNivå2027(Integer.valueOf(formatter.formatCellValue(cell)));



            //nivå 2026

            cell = row.getCell(NorskFörlagIndex.Nivå2026.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskFörlag.setNivå2026(Integer.valueOf(formatter.formatCellValue(cell)));
            ...
            cell = row.getCell(NorskFörlagIndex.Nivå2024.getValue());
            if (cell != null && cell.getCellType() != CellType.BLANK) norskFörlag.setNivå2024(Integer.valueOf(formatter.formatCellValue(cell)));
